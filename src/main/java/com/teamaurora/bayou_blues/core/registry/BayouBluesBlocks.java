...
public class BayouBluesBlocks {
    ...
    public static final RegistryObject<Block> TREE_MOSS = HELPER.createBlockNoItem("tree_moss", ()->new TreeMossBlock(AbstractBlock.Properties.create(Material.PLANTS).zeroHardnessAndResistance().sound(SoundType.PLANT).notSolid().doesNotBlockMovement().tickRandomly()));
}
